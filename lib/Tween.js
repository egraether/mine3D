...
var TWEEN = TWEEN || ( function () {
	...
	return {
		...
		update: function () {
			...
			if ( !tweens.length && _onCompleteCallback ) {
	...
	*/
	...
	this.complete = function() {
		...
		for ( property in _valuesDelta ) {
			...
			_object[ property ] = _valuesStart[ property ] + _valuesDelta[ property ];

		}

		if ( _onUpdateCallback !== null ) {

			_onUpdateCallback.call( _object, 1 );
